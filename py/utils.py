...
def mass_ratio(iso, lowfehgrid=True, minjk=0.3, maxjk=9999.):
    ...
    if lowfehgrid:
        ...
        jkey, kkey= 'J', 'K'
    weights = iso['deltaM']*(10**(iso[agekey]-9)/iso[Zkey])
    mask = (iso[jkey]-iso[kkey] > minjk) & (iso[jkey]-iso[kkey] < maxjk) & (iso['logg'] > 0.5) & (iso['logg'] < 3.5) & (10**(iso['logTe']) < 4750.) & (10**(iso['logTe']) > 3500)
...
def APOGEE_iso_samples(nsamples, rec, fehrange=[-1,-1.5], lowfehgrid = True):
    ...
    if lowfehgrid:
        ...
        mkey ='M_ini'
        jkey, hkey, kkey = 'J', 'H', 'K'
    mask = (trec[jkey]-trec[kkey] > 0.5)  & (Z2FEH(trec[zkey]) > fehrange[0]) & (Z2FEH(trec[zkey]) < fehrange[1]) & (trec[mkey] > 0.75) & (trec['logg'] > 0.5) & (trec['logg'] < 3.5) & (trec[logagekey] >= 10.) & ((10**trec['logTe']) < 4750) & ((10**trec['logTe']) > 3500)
    niso = sampleiso(nsamples,trec[mask], return_iso=True, lowfeh=lowfehgrid)
    mask = (trec[jkey]-trec[kkey] > 0.3001)  & (Z2FEH(trec[zkey]) > fehrange[0]) & (Z2FEH(trec[zkey]) < fehrange[1]) & (trec[mkey] > 0.75) & (trec['logg'] > 0.5) & (trec['logg'] < 3.5) & (trec[logagekey] >= 10.) & ((10**trec['logTe']) < 4750) & ((10**trec['logTe']) > 3500)
...
#         else: return True
    if densfunc is densprofiles.spherical:
    ...
    elif densfunc is densprofiles.axisymmetric:
        if params[0] < 0.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 1.:return False
        else: return True
    elif densfunc is densprofiles.triaxial_norot:
        if params[0] < 0.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 1.:return False
    ...
    elif densfunc is densprofiles.broken_spl:
        if params[0] < 0.:return False
        elif params[1] < 0.:return False
        elif params[2] < 0.:return False
        elif params[2] > 20.:return False
        else: return True
    elif densfunc is densprofiles.triaxial_single_angle_zvecpa:
        if params[0] < 0.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 1.:return False
        elif params[2] < 0.1:return False
    ...
    elif densfunc is densprofiles.triaxial_single_angle_zvecpa_plusexpdisk:
        if params[0] < 0.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 1.:return False
        elif params[2] < 0.1:return False
    ...
    elif densfunc is densprofiles.triaxial_single_cutoff_zvecpa_plusexpdisk:
        if params[0] < 0.:return False
        if params[1] < 0.01:return False
        elif params[2] < 0.1:return False
        elif params[2] > 1.:return False
    ...
    elif densfunc is densprofiles.triaxial_single_cutoff_zvecpa:
        if params[0] < 0.:return False
        if params[1] < 0.01:return False
        elif params[2] < 0.1:return False
        elif params[2] > 1.:return False
        ...
        elif params[6] >= 1.:return False #here we set the upper prior to be 0.9 instead of 1 as a value of 1 and 0 is the same (just flipped), and so the posterior samples look nice.
        else:return True
    elif densfunc is densprofiles.triaxial_broken_angle_zvecpa_plusexpdisk:
        if params[0] < 0.:return False
    ...
    elif densfunc is densprofiles.triaxial_einasto_zvecpa:
        if params[0] < 0.:return False
    ...
    elif densfunc is densprofiles.justexpdisk:
        if params[0] < 0.:return False
        elif params[0] > 10.:return False
        elif params[1] < 0.:return False
